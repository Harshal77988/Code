...
*/
(function(){var e=function(e){return jQuery.extend(this,e)};e.prototype.setStatus=function(e,f){var a,c;a=e.data.paging;!a||0>=a.pagesNumber?(this.$control.html(""),this.$control.addClass("jplist-empty")):(this.$control.removeClass("jplist-empty"),c=this.$control.attr("data-type"),c=c.replace("{current}",a.currentPage+1),c=c.replace("{pages}",a.pagesNumber),c=c.replace("{start}",a.start+1),c=c.replace("{end}",a.end),c=c.replace("{all}",a.itemsNumber),this.$control.html(c))};jQuery.fn.jplist.controls.PaginationInfo=
function(g){return new e(g)};jQuery.fn.jplist.controlTypes["pagination-info"]={className:"PaginationInfo",options:{}}})();(function(){var e=function(a,c){var b;b=null;var d;d=!1;b=a.$control.find("li[data-active]").eq(0);0>=b.length&&(b=a.$control.find("button").eq(0));b=c?0:Number(b.attr("data-number"))||0;(d="true"===a.$control.attr("data-jump-to-start")||a.controlOptions.jumpToStart)&&(d=a.history.getLastStatus())&&"pagination"!==d.type&&"views"!==d.type&&(b=0);d=Number(a.$control.attr("data-items-per-page"))||0;b=new jQuery.fn.jplist.controls.BootstrapPaginationDTO(b,d);return b=new jQuery.fn.jplist.StatusDTO(a.name,
a.action,a.type,b,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking)},g=function(a){a.$control.on("click","li",function(){var c,b=null;c=Number(jQuery(this).attr("data-number"))||0;b=e(a,!1);b.data.currentPage=c;a.observer.trigger(a.observer.events.knownStatusesChanged,[[b]])})},f=function(a){a.params={view:new jQuery.fn.jplist.controls.BootstrapPaginationView(a.$control,a.controlOptions)};g(a);return jQuery.extend(this,a)};f.prototype.getStatus=function(a){return e(this,a)};f.prototype.getDeepLink=
...
(this.$jplistFirst.removeClass("disabled"),this.$jplistPrev.removeClass("disabled"));a.currentPage==a.pagesNumber-1?(this.$jplistNext.addClass("disabled"),this.$jplistLast.addClass("disabled")):(this.$jplistNext.removeClass("disabled"),this.$jplistLast.removeClass("disabled"))};jQuery.fn.jplist.controls.BootstrapPaginationView=function(a,c){return new f(a,c)}})();(function(){var e=function(c){var a;a=c.params.$buttons.filter('[data-default="true"]').eq(0);0>=a.length&&(a=c.params.$buttons.eq(0));return a},g=function(a,b){var d=null,d=b?e(a):a.params.$buttons.filter('[data-jplist-selected="true"]'),d=new jQuery.fn.jplist.controls.BootstrapDropdownPaginationDTO(d.attr("data-number"));return d=new jQuery.fn.jplist.StatusDTO(a.name,a.action,a.type,d,a.inStorage,a.inAnimation,a.isAnimateToTop,a.inDeepLinking)},f=function(a){a.params.$buttons.on("click",function(b){var d;
b.preventDefault();d=g(a,!1);if(b=jQuery(this).attr("data-number"))d.data.number=b;a.observer.trigger(a.observer.events.knownStatusesChanged,[[d]])})},a=function(a){a.params={$textBox:a.$control.find('[data-type="selected-text"]'),$buttons:a.$control.find("[data-number]")};f(a);return jQuery.extend(this,a)};a.prototype.getStatus=function(a){return g(this,a)};a.prototype.getDeepLink=function(){var a="",b;this.inDeepLinking&&(b=g(this,!1),b.data&&(jQuery.isNumeric(b.data.number)||"all"===b.data.number)&&
...
"all"===a.data.number?this.params.$buttons.filter('[data-number="all"]'):this.params.$buttons.filter('[data-number="'+a.data.number+'"]');0<d.length&&(d.attr("data-jplist-selected",!0),this.params.$textBox.text(d.text()))};jQuery.fn.jplist.controls.BootstrapItemsPerPageDropdown=function(c){return new a(c)};jQuery.fn.jplist.controlTypes["boot-items-per-page-dropdown"]={className:"BootstrapItemsPerPageDropdown",options:{},dropdown:!0}})();(function(){jQuery.fn.jplist.controls.BootstrapDropdownPaginationDTO=function(e){return{number:e}}})();
