            ...
            <div id="owl-demo" class="deals-wk">
                ...
                <!-- <div class="item">
                    <div class="col-md-12">
                        <div class="pro-text text-center">
                            <div class="pro-img">
                                <img src="<?=base_url()?>frontend/assets/images/wk-deal-img.jpg" alt="2" />
                            </div>
                            <div class="text-text">
                                    ...
                                    <div class="col-xs-12 col-sm-3 col-md-3 product_link">
                                        ...
                                        <div class="pro-text text-center">
                                            ...
                                            <div class="pro-img" onclick="window.location.href='<?=base_url()?>product_detail/<?=$value['id']?>'">
                                                ...
                                                <?php } ?>
                                                <!-- .hover-icon -->
                                                <div class="hover-icon"> <a onclick="addToWishList(<?=$value['id']?>)"><span class="icon icon-Heart"></span></a> <a href="<?=base_url()?>product_detail/<?=$value['id']?>"><span class="icon icon-Search"></span></a>
                                                    <!--<a href="#"><span class="icon icon-Restart"></span></a>--></div>
                                                <!-- /.hover-icon -->
                                            </div>
                                            <!-- /.pro-img -->
                                            <div class="pro-text-outer">
                                                ...
                                                <input type="hidden" id="img_url_<?=$value['id'] ?>" name="img_url" value="<?=$image_url[0] ?>" />
                                                <p class="wk-price1">&dollar;<?=$value['rent']?><span>/<?php if($value['plan'] == '0') { echo $per = 'week'; } elseif ($value['plan'] == '1') { echo $per = 'month'; } elseif ($value['plan'] == '2') { echo $per = "year"; } elseif ($value['plan'] == '3') { echo $per = "Hour"; } elseif ($value['plan'] == '4') { echo $per = "Day"; }?></span></p>
                                                <?php if (isset($value['quantity']) && $value['quantity'] > 0) { ?>
                                                <a onclick="addToCart(<?=$value['id'] ?>)" class="add-btn">Add to cart</a>
                                                <?php } else {?>
                                                <a class="add-btn">Out of stock</a>
