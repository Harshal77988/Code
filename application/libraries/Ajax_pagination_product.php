...
class Ajax_pagination_product {
    ...
    var $last_tag_open = '&nbsp;';
    var $last_tag_close = '';
    var $cur_tag_open = "<li class='disabled'><li class='active'><a href='#' id='id_current'>";
...
//            $info = '';
        ...
        if ($this->show_count) {
            ...
            $info = '<span class="taxes_pagination">Showing ' . ( $curr_offset + 1 ) . ' to ';
        ...
        $output = $page_counts. $this->full_tag_open . $output . $this->full_tag_close;
        ?>
        <script>
