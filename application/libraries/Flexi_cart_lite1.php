...
class Flexi_cart_lite
{
	 ...
	 */
	public function total($inc_discount = TRUE, $format = FALSE, $internal_value = FALSE)
	{
		if ($inc_discount)
		{
			// Total up all taxable, non-taxable values and the carts total tax value.
	...
	{
		$item_summary_savings_total = $this->CI->flexi->cart_contents['settings']['discounts']['data']['summary_discount_savings'];
	 ...
	 */
	public function cart_savings_total($include_vouchers = TRUE, $format = FALSE, $internal_value = FALSE)
	{
		...
		// echo $this->format_currency(($item_summary_savings_total + $summary_savings_total + $reward_voucher_savings_total), $format, 2, $internal_value); die;
	 ...
	 */
	public function item_summary_discount_data($format = FALSE, $internal_value = TRUE)
	{	
	 ...
	 */
	private function get_active_discounts($discount_type = FALSE, $target = FALSE, $format = FALSE, $internal_value = FALSE)
	{
