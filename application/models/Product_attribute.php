...
class Product_attribute extends MY_Model {
    ...
    public $_table = 'tbl_product_attributes';
...
//    protected $soft_delete_key = 'isactive';
    ...
    function get_by_id($productId) {
        ...
        $this->db->join('tbl_products ip', 'ip.id = ipa.product_id');
    ...
    function get_details_by_id($productId) {
        ...
        $this->db->from('tbl_product_attributes ipa');
        $this->db->join('tbl_products ip', 'ipa.product_id = ip.id');
        $this->db->join('tbl_p_sub_attributes ipas', 'ipas.id = ipa.sub_attribute_id');
//        $this->db->join('tbl_p_sub_attributes ipas', 'ipas.id = ipa.sub_attribute_dp_id','LEFT');
        $this->db->where('ipa.product_id', $productId);
        $query = $this->db->get();
//        echo $this->db->last_query();die;
    ...
    function update_attr($attr_id, $data) {
        ...
        $this->db->update('tbl_product_attributes', $data);
    }
