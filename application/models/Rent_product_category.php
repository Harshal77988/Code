...
class Rent_product_category extends MY_Model {

    public $_table = 'tbl_rent_product_category';
    ...
    function delete_cat($pId) {
        ...
        return $this->db->delete('tbl_rent_product_category');
    }
...
//         $this->db->select('ipc.name, ipc.id, psc.p_category_id');
//         $this->db->from('tbl_product_category ipc');
//         $this->db->join('tbl_product_sub_category psc', 'ipc.id = psc.p_category_id', 'LEFT');
...
//     }
    ...
    public function get_all_categories() {
        ...
        $this->db->from('tbl_rent_product_category pc');
        $query = $this->db->get();
